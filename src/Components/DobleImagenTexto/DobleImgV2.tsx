export default function DobleImgV2() {
	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		<div>
			<h2 className="text-3xl font-bold tracki text-center sm:text-5xl text-gray-900">Proyectos en Desarrollo</h2>
			<p className="max-w-3xl mx-auto mt-4 text-xl text-center text-gray-600">Conoce en lo que estoy trabajando</p>
		</div>
		<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
			<div>
				<h3 className="text-2xl font-bold tracki sm:text-3xl text-gray-900">PROYECTO NOMBRE </h3>
				...
				<div className="mt-12 space-y-12">
					<div className="flex">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leadi text-gray-900">pROYECTO 2 NOMBRE</h4>
