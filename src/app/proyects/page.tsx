                ...
                <div className="mb-16 flex flex-wrap">
                    ...
                    <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
                        ...
                        <p className="text-neutral-500 dark:text-neutral-300">
                            ...
                            omnis quaerat blanditiis cumque dolore placeat rem
                            dignissimos?
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
                        ...
                        <p className="text-neutral-500 dark:text-neutral-300">
                            ...
                            odio vel lacus faucibus, tincidunt feugiat augue
                            ornare. Proin ac dui vel lectus eleifend vestibulum
                            et lobortis risus. Nullam in commodo sapien.
                            Curabitur ut erat congue sem finibus eleifend
                            egestas eu metus. Sed ut dolor id magna rutrum
                            ultrices ut eget libero. Duis vel porttitor odio. Ut
                            pulvinar sed turpis ornare tincidunt. Donec luctus,
                            mi euismod dignissim malesuada, lacus lorem commodo
                            leo, tristique blandit ante mi id metus. Integer et
                            vehicula leo, vitae interdum lectus. Praesent nulla
                            purus, commodo at euismod nec, blandit ultrices
                            erat. Aliquam eros ipsum, interdum et mattis vitae,
                            faucibus vitae justo. Nulla condimentum hendrerit
                            leo, in feugiat ipsum condimentum ac. Maecenas sed
                            blandit dolor.
                        </p>
                    </div>
                </div>
